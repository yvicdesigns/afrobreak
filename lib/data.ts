...
export const events: Event[] = [
  ...
  // ── QUALIFIERS ────────────────────────────────────────────────────────────────
  {
    id: 'e_qual_ghana', title: 'AfroBreak Ghana Qualifier',
    description: 'The national AfroBreak qualifier bringing together the best breakers from across Ghana to compete for a spot at the Africa Final in Accra.',
    date: '2025-06-14', time: '14:00', location: 'Accra, Ghana', city: 'Accra',
    type: 'Qualifier' as const, price: 0,
    image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800&q=80',
    instructor: 'Bboy Lyricx', capacity: 150, registered: 150,
    tags: ['qualifier', 'ghana', 'breaking', 'accra'],
  },
  {
    id: 'e_qual_benin', title: 'AfroBreak Benin Qualifier',
    description: 'Benin\'s finest breakers — including reigning champion Smith — battle for national glory and a place at the Africa Final. One of West Africa\'s most competitive qualifiers.',
    date: '2025-06-28', time: '15:00', location: 'Cotonou, Benin', city: 'Cotonou',
    type: 'Qualifier' as const, price: 0,
    image: 'https://images.unsplash.com/photo-1508700929628-c3d7819c1498?w=800&q=80',
  ...
  },
  {
    ...
    description: 'The East Africa hub. Ugandan breakers compete at the Kampala qualifier for their chance to represent at the AfroBreak Africa Final in Accra.',
    date: '2025-07-12', time: '14:00', location: 'Kampala, Uganda', city: 'Kampala',
    type: 'Qualifier' as const, price: 0,
    image: 'https://images.unsplash.com/photo-1516450137517-162bfbeb8dba?w=800&q=80',
  ...
  },
  {
    ...
    description: 'Abidjan hosts the AfroBreak Ivory Coast qualifier. Top breakers from Ivory Coast — led by Blanchard — bring raw energy and technical skill to the battle floor.',
    date: '2025-07-19', time: '15:00', location: 'Abidjan, Ivory Coast', city: 'Abidjan',
    type: 'Qualifier' as const, price: 0,
    image: 'https://images.unsplash.com/photo-1547153760-18fc86324498?w=800&q=80',
    instructor: 'ABA', capacity: 100, registered: 100,
  ...
  },
  {
    ...
    description: 'Lomé\'s breakers take centre stage at the Togo qualifier. Home of Chris Paul and Zira, Togo continues to produce standout talent for the continental stage.',
    date: '2025-07-26', time: '14:00', location: 'Lomé, Togo', city: 'Lomé',
    type: 'Qualifier' as const, price: 0,
    image: 'https://images.unsplash.com/photo-1504680177321-2e6a879d4e8f?w=800&q=80',
  ...
  },
  {
    ...
    description: 'The European leg of the AfroBreak qualifiers. African diaspora breakers in France compete for their place at the Africa Final in Accra, connecting the continent across borders.',
    date: '2025-08-09', time: '16:00', location: 'Paris, France', city: 'Paris',
    type: 'Qualifier' as const, price: 0,
    image: 'https://images.unsplash.com/photo-1526483291330-fe44429f3e0d?w=800&q=80',
    instructor: 'ABA', capacity: 100, registered: 100,
  ...
  },
  {
    ...
    description: 'Ouagadougou hosts the Burkina Faso qualifier. Dansi and the national crew represent one of West Africa\'s most culturally vibrant breaking scenes.',
    date: '2025-08-16', time: '14:00', location: 'Ouagadougou, Burkina Faso', city: 'Ouagadougou',
    type: 'Qualifier' as const, price: 0,
    image: 'https://images.unsplash.com/photo-1483362271674-7461064d5e66?w=800&q=80',
    instructor: 'ABA', capacity: 80, registered: 80,
  ...
  },
  {
    ...
    description: 'Nigeria — home of Lil Vic (AfroBreak African Champion 2023) — sends its finest to battle at the Lagos qualifier. The largest national breaking talent pool on the continent.',
    date: '2025-08-30', time: '15:00', location: 'Lagos, Nigeria', city: 'Lagos',
    type: 'Qualifier' as const, price: 0,
